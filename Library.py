...
root = Tk()
root.title("Library Management System - Perpustakaan Dusun Gandu 1")
root.iconphoto(False, PhotoImage(file="ala.png"))
...
class maincode:
     ...
     def login(self):
         ...
         if self.ab!=None:
             ...
             self.lb3=Label(self.fm2,text='DASHBOARD',fg='White',bg='#0f624c',font=('Arial',25,'bold'))
             self.lb3.place(x=325,y=17)


             #----------------------------name------------------------

             self.name=Label(root,text="Nama : ",bg='#fff',fg="black",font=('Arial',10,'bold'))
     ...
     def cur(self):
             ...
             self.develop=Label(self.fm3,text='KKN R8546 UNY 2023',bg='#fff',fg='blue',
                               font=('Arial',12,'italic','bold'))
             self.develop.place(x=600,y=350)

             #-----------------addbutton-----------------

             self.bt1=Button(self.fm3,text='  Tambah Buku',fg='#fff',bg='#ff0076',font=('Arial',15,'bold'),width=170,
             ...
             self.bt2 = Button(self.fm3, text='  Pinjam Buku', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
             ...
             self.bt3 = Button(self.fm3, text='  Edit Buku', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
             ...
             self.bt4 = Button(self.fm3, text='  Kembalikan', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
             ...
             self.bt5 = Button(self.fm3, text=' Hapus Buku', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
             ...
             self.bt6 = Button(self.fm3, text='  Lihat Buku', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
             ...
             self.bt7 = Button(self.fm3, text=' Cari Buku', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
     ...
     def addbook(self):
         class temp(maincode):
             ...
             def book(self):
                 ...
                 self.lb2 = Label(self.fm1, text='Judul', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb2.place(x=70, y=130)
                 self.lb3 = Label(self.fm1, text='Penulis', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb3.place(x=70, y=170)
                 self.lb4= Label(self.fm1, text='Edisi', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb4.place(x=70, y=210)
                 self.lb5 = Label(self.fm1, text='Kategori', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
             ...
             def submit1(self):
                 ...
                 cursor=dd.cursor()
                 cursor.execute("INSERT INTO stbook (ID_Buku,Judul,Penulis,Edisi,Kategori) values(?,?,?,?,?)",(self.id,self.ttl,self.aut,self.edi,self.pri))
                 dd.commit()
                 self.clear()
     ...
     def issuebook(self):
         class test(maincode):
              ...
              def issue(self):
                  ...
                  self.lc=Label(self.ffb,text='USER  INFORMATION',bg='#0f624c',fg='#fff',font=('Arial',12,'bold'))
                  self.lc.place(x=55,y=5)

                  self.lb=Label(self.fc,text='User-ID',bg='#fff',fg='black',font=('Arial',10,'bold'))
                  ...
                  self.lb = Label(self.fc, text='Nama', bg='#fff', fg='black', font=('Arial', 10, 'bold'))
...
#Pinjam Buku
              def check(self):
                  ...
                  self.b=self.em2.get()
                  cursor=dc.cursor()
                  cursor.execute("SELECT * FROM student WHERE User_ID='"+self.ai+"' or Name='"+self.b+"'")
                  ...
                  if self.var!=None:
                        ...
                        self.lb=Label(self.ff,text='PINJAM BOOK',bg='#0f624c',fg='#fff',font=('Arial',12,'bold'))
                        self.lb.place(x=165,y=5)
                        self.tt=Label(self.fr,text='ID Buku',bg='#fff',fg='black',font=('arial',10,'bold'))
                        self.tt.place(x=50,y=60)
                        self.e1 = Entry(self.fr, width=30, bd=5, relief='ridge', font=('Arial', 8, 'bold'))
                        self.e1.place(x=160, y=60)
                        self.ttp = Label(self.fr, text='Judul', bg='#fff', fg='black', font=('arial', 10, 'bold'))
              ...
              def data(self):
                   ...
                   cursor=dd.cursor()
                   cursor.execute("SELECT * FROM stbook WHERE ID_Buku='"+self.vva+"' and Judul='"+self.vvb+"'")
                   ...
                   if self.value!=None:
                        if self.max==0:
                              ...
                              self.lb=Label(self.boot,text='Judul',bg='#fff',fg='black',font=('Arial',10,'bold'))
                              ...
                              self.lb = Label(self.boot, text='Penulis', bg='#fff', fg='black', font=('Arial', 10,
                                                                                                    'bold'))
                              self.lb.place(x=30, y=60)
                              self.lbn = Label(self.boot, text=self.value[2], bg='#fff', fg='black', font=('Arial', 10,
                                                                                                    'bold'))
                              self.lbn.place(x=120, y=60)
                              self.lb = Label(self.boot, text='Edisi', bg='#fff', fg='black', font=('Arial', 10,
                                                                                                    'bold'))
                        ...
                        if self.max==1:
                              ...
                              self.lbt = Label(self.boot, text='Judul', bg='#fff', fg='black', font=('Arial', 10,
                                                                                                    'bold'))
                              ...
                              self.lbtd = Label(self.boot, text='Penulis', bg='#fff', fg='black', font=('Arial', 10,
                                                                                                    'bold'))
                              self.lbtd.place(x=30, y=180)
                              self.lbn = Label(self.boot, text=self.value[2], bg='#fff', fg='black', font=('Arial', 10,
                                                                                                    'bold'))
                              self.lbn.place(x=120, y=180)
                              self.lbc = Label(self.boot, text='Edisi', bg='#fff', fg='black', font=('Arial', 10,
                                                                                                    'bold'))
              ...
              def issued(self):
                    ...
                    comm.execute("UPDATE student SET From_date='"+str(self.x)+"', To_date='"+str(self.datecon)+"' "
                                                                                                               "WHERE Roll_no='"+self.ai+"' or User_ID='"+self.b+"'")
                    dc.commit()
              ...
              def mail(self):
                    ...
                    cursor=dc.cursor()
                    cursor.execute("SELECT * FROM student WHERE User_ID='"+self.baby+"'")
                    self.var=cursor.fetchone()
     ...
     def edit(self):
         class editing(maincode):
               def edbooks(self):
                     ...
                     self.label3=Label(self.fm1,text='ID Buku',bg='#fff',fg='black',font=('arial',10,'bold'))
               ...
               def search(self):
                     ...
                     cursor=dd.cursor()
                     cursor.execute("SELECT * FROM stbook WHERE ID_Buku='"+self.datas+"'" )
                     dd.commit()
...
#Edit Buku
                          ...
                          self.labid = Label(self.edcat, bg='#fff', fg='black', text='ID Buku', font=('arial', 10,
                                                                                                    'bold'))
                          self.labid.place(x=30, y=45)
                          self.labti = Label(self.edcat, bg='#fff', fg='black', text='Judul', font=('arial', 10,
                                                                                                    'bold'))
                          self.labti.place(x=30, y=90)
                          self.labaut = Label(self.edcat, bg='#fff', fg='black', text='Penulis', font=('arial', 10,
                                                                                                    'bold'))
                          self.labaut.place(x=30, y=135)
                          self.labed = Label(self.edcat, bg='#fff', fg='black', text='Edisi', font=('arial', 10,
                                                                                                    'bold'))
                          self.labed.place(x=30, y=180)
                          self.labpr = Label(self.edcat, bg='#fff', fg='black', text='Kategori', font=('arial', 10,
                                                                                                    'bold'))
                         ...
                         # -------------------insert value within edcat windows--------------------
                          ...
                          messagebox.showerror('Library System','PLEASE! CORRECT ID Buku')
               ...
               def savedit(self):
                     ...
                     cursor= dd.cursor()
                     cursor.execute("UPDATE stbook SET ID_Buku='"+self.id+"', Judul='"+self.ti+"',Penulis='"+self.au+"',Edisi='"+self.ed+"',Kategori='"+self.pi+"' WHERE ID_Buku='"+self.datas+"'")
                     dd.commit()
     ...
     def return_book(self):
         class retu(maincode):
             ...
             def __init__(self):
                 ...
                 self.ed.place(x=0, y=0)
                 self.lac = Label(self.ed, text='KEMBALIKAN BUKU ', bg='#0f624c', fg='#fff', font=('Arial', 12, 'bold'))
                 self.lac.place(x=175, y=5)
                 self.label8 = Label(self.f1, text='USER ID', bg='#fff', fg='black', font=('arial', 10, 'bold'))
             ...
             def retbook(self):
                 ...
                 cursor=dc.cursor()
                 cursor.execute("SELECT * FROM student WHERE User_ID='"+self.entry+"'")
                 dc.commit()
                 ...
                 if self.data!=None:
                     ...
                     cursor.execute("UPDATE student SET submit_date='" + str(
                         self.get_date) + "' WHERE User_ID='" + self.entry + "'")
                     dc.commit()
                 ...
                 #-----------------between two date calculate days---------------------
                         ...
                         self.lb=Label(self.tom,text="Buku Dikembalikan",bg="#fff",fg="black",font=('arial',17,'bold'))
                         self.lb.place(x=75,y=60)


                         if chm<=0:
                             self.lc1 = Label(self.tom, text="-", bg="#fff", fg="black", font=('arial', 12,
                                                                                                    'bold'))
                         ...
                         cursor1.execute("UPDATE student SET From_date='',To_date='',submit_date='',No_book='',"
                                         "Charge='"+str(self.charge)+"' WHERE User_ID='"+self.entry+"'")
                         dc.commit()
                     ...
                     messagebox.showwarning("Library System","YOUR User_ID IN NOT FOUND !")
     ...
     def delete(self):
         class dele(maincode):
               def deleteee(self):
                     ...
                     self.lac.place(x=175, y=5)
                     self.label8 = Label(self.f1, text='ID Buku', bg='#fff', fg='black', font=('arial', 10, 'bold'))
                     self.label8.place(x=85, y=65)
                     self.entry4 = Entry(self.f1, width=30, bd=4, relief='groove', font=('arial', 8, 'bold'))
                     self.entry4.place(x=188, y=65)
               ...
               def deldata(self):
                     ...
                     cursor=dd.cursor()
                     cursor.execute("DELETE FROM stbook WHERE ID_Buku='"+self.a+"'")
                     dd.commit()
     ...
     def search(self):
         class demt(maincode):
             def delmdata(self):
                 ...
                 self.lac.place(x=175, y=5)
                 self.label8 = Label(self.fc1, text='ID Buku', bg='#fff', fg='black', font=('arial', 10, 'bold'))
                 self.label8.place(x=85, y=65)
             ...
             def srch(self):
                 ...
                 cursor=dd.cursor()
                 cursor.execute("SELECT * FROM stbook WHERE ID_Buku='"+self.emp+"'")
                 dd.commit()
                 ...
                 if self.srval!=None:
                     ...
                     self.lb1 = Label(self.top, text='Judul', bg='#fff', fg='black', font=('arial', 12, 'bold'))
                     ...
                     self.lb3 = Label(self.top, text='Penulis', bg='#fff', fg='black', font=('arial', 12, 'bold'))
                     ...
                     self.lb5 = Label(self.top, text='Edisi', bg='#fff', fg='black', font=('arial', 12, 'bold'))
     ...
     def show(self):
         class tst(maincode):
             def __init__(self):
                 ...
                 self.book_table=ttk.Treeview(self.table_frame,columns=("ID Buku","Judul","Penulis","Edisi",
                                                                           "Kategori"),
                 ...
                 self.book_table.heading("ID Buku",text="ID Buku")
                 self.book_table.heading("Judul", text="Judul")
                 self.book_table.heading("Penulis", text="Penulis")
                 self.book_table.heading("Edisi", text="Edisi")
                 self.book_table.heading("Kategori", text="Kategori")
                 self.book_table['show']='headings'
                 self.book_table.column("ID Buku",width=200)
                 self.book_table.column("Judul", width=200)
                 self.book_table.column("Penulis", width=200)
                 self.book_table.column("Edisi", width=120)
                 self.book_table.column("Kategori", width=110)
